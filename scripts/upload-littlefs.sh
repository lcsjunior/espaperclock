...
#
# Matches the "Huge APP (3MB No OTA/1MB SPIFFS)" partition scheme. If
# Tools > Partition Scheme changes in the IDE, update
...
CHIP="${CHIP:-esp32c3}"
BAUD="${BAUD:-921600}"
PARTITION_OFFSET="${PARTITION_OFFSET:-0x310000}"
PARTITION_SIZE="${PARTITION_SIZE:-0xE0000}"
